...
class CoordinateViewerFinalRMSE:
    def __init__(self):
        ...
        # Robot ismini kontrol et (sim_p3at veya pioneer3at)
        ...
        # Baslangic Ofsetleri (Kalibrasyon icin)
        self.offset_x = None
        self.offset_y = None
        self.initialized = False
        self.gazebo_ready = False
        
        # RMSE Icin Degiskenler
        self.sum_sq_error = 0.0 # Hatalarin karesinin toplami
        self.sample_count = 0   # Kac kere olcum yaptik
    ...
    def run(self):
        rate = rospy.Rate(5) # 5 Hz guncelleme
        rospy.sleep(1.0) # TF buffer dolsun
        ...
        while not rospy.is_shutdown():
            try:
                ...
                if self.gazebo_ready:
                    # 2. KALIBRASYON (Sadece ilk seferde)
